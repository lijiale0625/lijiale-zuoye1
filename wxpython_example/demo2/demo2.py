...
# 预先定义的指令列表
COMMAND = ['busybox mount -t nfs -o nolock,ro,mountvers=2 192.168.1.128:/iptv /mnt', 'cd mnt/czy/llz/soundddz',
           'sh run.sh']
...
class MyFrame(wx.Frame):
    ...
    def OnExit(self, event):
        ...
        if self.isconnected:
            dlg = wx.MessageDialog(parent=None, message="如果现在退出，将会丢失远程登录连接，是否确认退出?", caption="警告",
