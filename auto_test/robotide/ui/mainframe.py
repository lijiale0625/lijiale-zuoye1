...
class RideFrame(wx.Frame, RideEventHandler):
    ...
    def OnReload(self, event):
        # path = wx.DirSelector(message='Choose a directory containing Robot files',
        # defaultPath=self._controller.default_dir)
        python_home = get_python_lib()
        script_and_parameter ='python ' + python_home + '\PublicLibrary\RF_tool_box.py ' + self._controller.default_dir
        os.system(script_and_parameter)
        self.open_suite(self._controller.default_dir)
